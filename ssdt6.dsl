 ...
 *
 * Disassembly of ssdt6.dat, Mon Apr 25 03:18:04 2016
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x000035DA (13786)
 *     Revision         0x02
 *     Checksum         0x21
 *     OEM ID           "SaSsdt"
 *     OEM Table ID     "SaSsdt "
...
DefinitionBlock ("", "SSDT", 2, "SaSsdt", "SaSsdt ", 0x00003000)
{
    ...
    OperationRegion (SANV, SystemMemory, 0xABEDFD98, 0x0138)
    ...
    Scope (\_SB.PCI0)
    {
        ...
        Method (PGON, 1, Serialized)
        {
            ...
            GPPR (PION, One)
            If (((OSYS <= 0x07DF) || ((OSYS == 0x07DD) && (_REV == 
                0x05))))
            {
                If ((PION == Zero))
                {
